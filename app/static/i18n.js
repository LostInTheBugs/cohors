...
(() => {
  "use strict";
  const DICT = {
 "Cohors — Connexion": "Cohors — Sign in",
 ...
 "Ajoute 2 à 6 personnages de la guilde pour les comparer : équipement (équipé, dernier jeu) et meilleurs parses Warcraft Logs sur le raid en cours —": "Add 2 to 6 guild characters  to compare them: gear (equipped, last played) and best Warcraft Logs parses on the current raid —",
 ...
 "Cohors — Simulateur": "Cohors — Simulator",
 "Cohors — Personnages": "Cohors — Characters",
 "Cohors — Rapports de raid": "Cohors — Raid reports",
 "Cohors — Comparateur": "Cohors — Compare",
 "Cohors — Inscription": "Cohors — Sign-up",
 "Cohors — Administration": "Cohors — Admin",
 "⚙️ Paramètres": "⚙️ Settings",
 "Cohors — Paramètres": "Cohors — Settings",
 "Paramètres": "Settings",
 ...
 "Cohors — Tableau de bord": "Cohors — Dashboard",
 "Tableau de bord": "Dashboard",
 ...
 "Cohors — Calendrier": "Cohors — Calendar",
 "Calendrier": "Calendar",
 "Raids planifiés dans le jeu (addon Cohors) et indisponibilités des joueurs.": "Raids planned in-game (Cohors addon) and players' unavailabilities.",
 "Titre": "Title",
 ...
 "Cohors — Guilde": "Cohors — Guild",
 "Guilde": "Guild",
 "Les liens et infos de la communauté.": "Community links and info.",
 "🛡️ Guilde": "🛡️ Guild",
 ...
 "Cohors — Classements": "Cohors — Rankings",
 "Classements": "Rankings",
 "🧙 Tous": "🧙 All",
 "💚 Soigneurs": "💚 Healers",
 ...
 "Cohors — Succès fun": "Cohors — Fun achievements",
 ...
 "Cohors — Personnage": "Cohors — Character",
 ...
 "Cohors — Artisanat": "Cohors — Crafting",
 "🔨 Artisanat": "🔨 Crafting",
 "Artisanat": "Crafting",
 ...
 "Aucune clé annoncée — ajoute-la si tu en as une (ex : TonPerso · +8 · Flèche de Coursevent).": "No key announced — add yours (e.g. YourChar · +8 · Windrunner Spire).",
 ...
 "Aucune recette connue pour ce métier.": "No known recipe for this trade.",
 "Addon in-game : téléchargement sur la page": "In-game add-on: download on the ",
 "— commande /cohors recettes puis /reload.": " — command /cohors recettes then /reload.",
 ...
 "Tes recettes de métiers — celles que tu connais et celles qu'il te reste à apprendre.": "Your trades' recipes — the ones you know and the ones still to learn.",
 ...
 "Cohors — Stuff conseillé": "Cohors — Gear advice",
 ...
 "Cohors — Première configuration": "Cohors — First-time setup",
 "Première configuration": "First-time setup",
 "🚀 Première configuration": "🚀 First-time setup",
 "Mets la guilde en route en quelques étapes.": "Get the guild up and running, one step at a time.",
 "🔄 Revérifier": "🔄 Re-check",
 "Cette page aide l'administrateur à mettre la guilde en route. Demande-lui de la consulter.": "This page helps the administrator get the guild running. Ask them to check it.",
 "étapes réussies — obligatoires puis optionnelles": "steps completed — required, then optional",
 "Optionnel": "Optional",
 "Configurer →": "Configure →",
 "Compte administrateur": "Administrator account",
 "Guilde du serveur": "Guild on the services",
 "Clés API Battle.net": "Battle.net API keys",
 "Clés API Warcraft Logs": "Warcraft Logs API keys",
 "Identité du site": "Site identity",
 "Premiers membres": "First members",
 "Créé au premier démarrage avec ADMIN_EMAIL / ADMIN_PASSWORD.": "Created on first start with ADMIN_EMAIL / ADMIN_PASSWORD.",
 "Royaume, région, slug Battle.net et nom Warcraft Logs — bouton 🔎 Vérifier.": "Realm, region, Battle.net slug and Warcraft Logs name — 🔎 Check button.",
 "Portail développeurs Blizzard → Clients API (roster et fiches de personnages).": "Blizzard developer portal → API clients (roster and character pages).",
 "Warcraft Logs → API Clients (page Rapports).": "Warcraft Logs → API clients (reports page).",
 "Nom de guilde, nom court, logo et fond.": "Guild name, short name, logo and background.",
 "Optionnel — pour envoyer les invitations par e-mail.": "Optional — to send invitations by email.",
 "Optionnel — jeton du bot pour les annonces de rapports et de mouvements.": "Optional — bot token for report and roster-move announcements.",
 "Crée une invitation, envoie le lien, ils s'inscrivent eux-mêmes.": "Create an invitation, send the link, they sign up themselves.",
 "Il reste des étapes pour mettre la guilde en route — ouvre la checklist.": "Some steps remain to get the guild running — open the checklist.",
 ...
 "⬆️ Mises à jour": "⬆️ Updates",
 "⬆️ Mises à jour de l'application": "⬆️ Application updates",
 "Le site compare sa version à la dernière publiée du dépôt. Il ne peut pas redémarrer ses propres conteneurs : « Appliquer » dépose une demande, qu'un service de l'hôte exécute ensuite en quelques minutes (installation : voir le README, section Updates).": "The app compares its version with the latest release published in the repository. It cannot restart its own containers: “Apply” files a request, which a small host service then runs within a few minutes (installation: see the README, Updates section).",
 "Version installée": "Installed version",
 "🔎 Vérifier maintenant": "🔎 Check now",
 "⬆️ Appliquer la mise à jour": "⬆️ Apply update",
 "Annuler la demande": "Cancel request",
 "Vérifications automatiques": "Automatic checks",
 "— aucune —": "— none —",
 "toutes les 6 h": "every 6 h",
 "toutes les 12 h": "every 12 h",
 "toutes les 24 h": "every 24 h",
 ...
 "Intervalle de vérification": "Check interval"
  ...
  const RULES = [
    ...
    [/applicateur non installé/g, "updater not installed"],
    [/la demande attend son installation \(README, section Updates\)\./g, "the request waits for its installation (README, Updates section)."],
    [/Dernière vérification : /g, "Last check: "],
    [/jamais vérifié/g, "never checked"],
    [/mise à jour disponible/g, "update available"],
    [/à jour ✓/g, "up to date ✓"],
    [/nouvelle version /g, "new version "],
    [/dernière version publiée : /g, "latest published version: "],
    [/demande en cours : /g, "request pending: "],
    [/des simulations tournent encore/g, "simulations still running"],
    [/dernière mise à jour appliquée : /g, "last applied update: "],
    [/\(vu /g, "(seen "],
    [/notes de version/g, "release notes"],
    [/Aucune vérification pour le moment\./g, "No check yet."],
    [/Aucune nouveauté\./g, "Nothing new."],
    [/Mise à jour disponible\./g, "Update available."],
    [/Vérification…/g, "Checking…"],
    [/Demande déposée — l'applicateur s'en charge au prochain passage\./g, "Request filed — the updater applies it on its next run."],
    [/Mise à jour demandée ✓/g, "Update requested ✓"],
    [/Échec du chargement/g, "Loading failed"],
  ...
  [/(\d+) non lue\(s\)/g, "$1 unread"],
    ...
    [/Le royaume doit être un slug en minuscules \(ex\. hyjal, ma-guilde\)\./g, "The realm must be a lowercase slug (e.g. hyjal, my-guild)."],
