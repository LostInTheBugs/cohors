...
(() => {
 ...
 "🗓️ « Prochains raids » : les officiers importent le calendrier de guilde de WoW (addon LOTP → /lotp → « Exporter ») — les raids, les réponses des membres (aux couleurs de leur classe, comme en jeu) et les indisponibilités déclarées apparaissent directement (création et invitations en jeu uniquement). Sur chaque date, les officiers peuvent préciser le ou les raids visés, les boss, et le raid de départ 🚩 (bouton ✏️) ; ils y définissent aussi le rôle des présents (🛡️ tank / 💚 heal / ⚔️ dps) et peuvent forcer les réponses (accepter ou refuser quelqu'un qui ne répond jamais en jeu).": "🗓️ « Upcoming raids »: officers import WoW's guild calendar (LOTP addon → /lotp → « Export ») — raids, members' answers (in their class colours, like in-game) and declared unavailabilities show up directly (creation and invites happen in-game only). For each date, officers can specify the targeted raid(s), the bosses, and the starting raid 🚩 (✏️ button); there they also set attendees' roles (🛡️ tank / 💚 heal / ⚔️ dps) and can force answers (accept or decline someone who never answers in-game).",
