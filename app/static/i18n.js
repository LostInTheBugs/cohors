...
(() => {
 ...
 "Les recettes connues apparaissent dans « Qui peut crafter quoi » (préparation de raid). Coche ou décoche, puis « Enregistrer » — le reste s'affiche dans « À apprendre ».": "Known recipes show up in « Who can craft what » (raid prep). Tick or untick, then « Save » — the rest shows under « To learn ».",
 ...
 "📖 « Mes recettes » (page 🙋 Moi) : chaque joueur déclare les recettes de ses métiers — en cochant parmi les recettes connues (le reste s'affiche dans « À apprendre »), ou en important son export d'addon (/cohors recettes).": "📖 « My recipes » (🙋 Me page): every player declares their trades' recipes — by ticking among the known recipes (the rest shows under « To learn »), or by importing their addon export (/cohors recettes).",
