...
(() => {
 ...
 "📖 « Mes recettes connues » (page 🙋 Moi) : chaque joueur déclare les recettes de ses métiers — en cochant dans la liste récupérée du jeu, ou en important son export d'addon (/cohors recettes).": "📖 « My known recipes » (🙋 Me page): every player declares their trades' recipes — by ticking from the list fetched from the game, or by importing their addon export (/cohors recettes).",
