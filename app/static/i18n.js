...
(() => {
 ...
 "🗓️ « Prochains raids » : les officiers importent le calendrier de guilde de WoW (addon LOTP → /lotp → « Exporter ») — les raids, les réponses des membres et les indisponibilités déclarées apparaissent directement (création et invitations en jeu uniquement).": "🗓️ « Upcoming raids »: officers import WoW's guild calendar (LOTP addon → /lotp → « Export ») — raids, members' answers and declared unavailabilities show up directly (creation and invites happen in-game only).",
