...
(() => {
 ...
 "📚 Catalogue : les recettes du jeu (2 dernières extensions, synchronisées automatiquement) ou les recettes des artisans de la guilde (importées depuis l'addon) — tu vois qui peut crafter quoi.": "📚 Catalog: game recipes (last 2 expansions, synced automatically) or the guild crafters' recipes (imported from the addon) — you see who can craft what.",
 ...
 "📚 Artisans : /lotp recettes (ou le bouton 📚) liste les recettes connues de tes métiers ; l'export vient enrichir le catalogue de 🧪 Préparation de raid.": "📚 Crafters: /lotp recettes (or the 📚 button) lists the recipes known by your professions; the export feeds the 🧪 Raid prep catalog.",
