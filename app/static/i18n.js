...
(() => {
 ...
 "Aucune recette du jeu pour le moment — la synchro se fait toute seule (au démarrage puis tous les jours).": "No game recipe yet — sync runs on its own (at startup and daily).",
 ...
 "⚙️ Recettes maison & catalogue : les recettes du jeu (2 dernières extensions, synchronisées automatiquement) ou les recettes des artisans de la guilde (déclarées : import d'addon ou sélection sur la page 📖 Mes recettes) — tu vois qui peut crafter quoi.": "⚙️ House recipes & catalogue: game recipes (last 2 expansions, synced automatically) or the guild crafters' recipes (declared: addon import or selection on the 📖 My recipes page) — you see who can craft what.",
