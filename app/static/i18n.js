...
(() => {
 ...
 "Pense à réexporter ton personnage quand tu changes de stuff : la page travaille toujours sur le dernier export enregistré.": "Remember to re-export your character when your gear changes: the page always works from the latest saved export."
  ...
  [/(\d+) non lue\(s\)/g, "$1 unread"],
    ...
    [/Build : /g, "Build: "],
    [/Priorité : /g, "Priority: "],
    [/(\d+) pièce\(s\) analysée\(s\) sur (\d+)/g, "$1 item(s) analysed out of $2"],
    [/(\d+) écartée\(s\) : non portables/g, "$1 skipped: not wearable"],
    [/À porter : /g, "Wear: "],
    [/Échec : /g, "Failed: "],
    ...
    [/Spé : /g, "Spec: "],
    [/Classe : /g, "Class: "],
    [/(\d+) pièce\(s\) équipée\(s\)/g, "$1 item(s) equipped"],
    [/(\d+) pièce\(s\) dans les sacs/g, "$1 item(s) in bags"],
    [/(\d+) build\(s\) détecté\(s\)/g, "$1 build(s) detected"],
    [/itérations/g, "iterations"],
  ];
