...
(() => {
 ...
 "Lie tes personnages de la guilde en un clic — ils s'affichent avec leur équipement. Le champ propose les noms au fil de la frappe (ex. « sala » → Arssalag) : clique sur le bon pour le lier.": "Link your guild characters in one click — they show with their equipment. The field suggests names as you type (e.g. « sala » → Arssalag): click the right one to link it.",
 ...
 "📖 « Mes recettes connues » : chaque joueur déclare les recettes de ses métiers — en cochant dans la liste récupérée du jeu, ou en important son export d'addon (/lotp recettes).": "📖 « My known recipes »: every player declares their trades' recipes — by ticking them from the list fetched from the game, or by importing their addon export (/lotp recettes).",
